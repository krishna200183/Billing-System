...
root.title("AGRAWAL Restaurant ")
root.configure(background='green')
root.iconbitmap(r'rest.ico')

Tops = Frame(root, bg='green', bd=20, pady=5, relief=RIDGE)
Tops.pack(side=TOP)

lblTitle = Label(Tops, font=('arial', 60, 'bold'), text='AGRAWAL RESTAURANT ', bd=21, bg='black',
...
Bananajuice = Checkbutton(Drinks_F, text='Bananajuice   40', variable=var1, onvalue=1, offvalue=0,font=('arial', 18, 'bold'),bg='orange', command=chk_Bananajuice).grid(row=0, sticky=W)
Grapejuice = Checkbutton(Drinks_F,  text='Grapejuice     50', variable=var2, onvalue=1, offvalue=0, font=('arial', 18, 'bold'),bg='orange', command=chk_Grapejuice).grid(row=1, sticky=W)
Pineapple = Checkbutton(Drinks_F,   text='Pineapple      60', variable=var3, onvalue=1, offvalue=0, font=('arial', 18, 'bold'),bg='orange', command=chk_Pineapple).grid(row=2, sticky=W)
Apple = Checkbutton(Drinks_F,       text='Apple             60', variable=var4, onvalue=1, offvalue=0, font=('arial', 18, 'bold'),bg='orange', command=chk_Apple).grid(row=3, sticky=W)
Promaganate = Checkbutton(Drinks_F, text='Promaganate 50', variable=var5, onvalue=1, offvalue=0,font=('arial', 18, 'bold'),bg='orange', command=chk_Promaganate).grid(row=4, sticky=W)
Sprite = Checkbutton(Drinks_F,      text='Sprite             30', variable=var6, onvalue=1, offvalue=0, font=('arial', 18, 'bold'),bg='orange', command=chk_Sprite).grid(row=5, sticky=W)
CocaCola = Checkbutton(Drinks_F,    text='CocaCola       30', variable=var7, onvalue=1, offvalue=0, font=('arial', 18, 'bold'),bg='orange', command=chk_CocaCola).grid(row=6, sticky=W)
Milkshakes = Checkbutton(Drinks_F,  text='Milkshakes    90', variable=var8, onvalue=1, offvalue=0, font=('arial', 18, 'bold'),
...
Vegbiryani = Checkbutton(Food_F,   text="Vegbiryani        100", variable=var9, onvalue=1, offvalue=0,font=('arial', 16, 'bold'), bg='orange', command=chk_Vegbiryani).grid(row=0, sticky=W)
Nonvegbiyani = Checkbutton(Food_F, text="Nonvegbiyani   180", variable=var10, onvalue=1, offvalue=0,font=('arial', 16, 'bold'), bg='orange', command=chk_Nonvegbiryani).grid(row=1, sticky=W)
Vegmeals = Checkbutton(Food_F,     text="Vegmeals         120", variable=var11, onvalue=1, offvalue=0,font=('arial', 16, 'bold'), bg='orange', command=chk_Vegmeals).grid(row=2, sticky=W)
Chapathi = Checkbutton(Food_F,     text="Chapathi            40", variable=var12, onvalue=1, offvalue=0,font=('arial', 16, 'bold'), bg='orange', command=chk_Chapathi).grid(row=3, sticky=W)
Manchuria = Checkbutton(Food_F,    text="Manchurian        70", variable=var13, onvalue=1, offvalue=0,font=('arial', 16, 'bold'), bg='orange', command=chk_Manchuria).grid(row=4, sticky=W)
Noodels = Checkbutton(Food_F,      text="Noodels             80", variable=var14, onvalue=1, offvalue=0, font=('arial', 16, 'bold'), bg='orange', command=chk_Noodels).grid(row=5, sticky=W)
Friedrice = Checkbutton(Food_F,    text="Friedrice            80", variable=var15, onvalue=1, offvalue=0, font=('arial', 16, 'bold'), bg='orange', command=chk_Friedrice).grid(row=6, sticky=W)
Frinchfries = Checkbutton(Food_F,  text="Frenchfries      110", variable=var16, onvalue=1, offvalue=0, font=('arial', 16, 'bold'), bg='orange', command=chk_Frinchfries).grid(row=7, sticky=W)
################################################Entry Box For Cake##########################################################
